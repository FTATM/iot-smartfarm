...
class ChickenFarmHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Width = isSmallScreen
        ? screenWidth *
              0.50 // เปลี่ยนเป็น 50% สำหรับหน้าจอเล็ก
        : isLandscape
        ? screenWidth *
              0.50 // แนวนอนให้แคบลง 50%
        : screenWidth < 600
        ? screenWidth *
              0.50 // หน้าจอกลาง 60%
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: ChickenFarmHeader(title: user['b_name']?.toString().toUpperCase() ?? 'UNKNOWN FARM #1'),
                ),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  width: leftWidth,
                                  // height: isLandscape ? 300 : imageHeight - (containerWidth * 0.1),
                                  alignment: Alignment.center,
                                  // color: Colors.amber,
