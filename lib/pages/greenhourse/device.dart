                          ...
                          Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  hintText: "เลือก Branch ของ Device",
                                  filled: true,
                                  fillColor: const Color(0xFFF9FAFB),
                                  contentPadding: const EdgeInsets.symmetric(
                                    horizontal: 16,
                                    ...
                                    if (newname['newname'] != '') {
                                      ...
                                      if (response['status'] == 'success') {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            content: Text("Device ใหม่ ${newname['newname']} ถูกสร้างแล้ว!"),
                                          ),
                                        );
                                      } else {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(content: Text("Device ใหม่ จำเป็นต้องมีชื่อ!")),
                                      );
                                    }
                                    newname['newname'] = '';
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if (response['status'] == 'success') {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text("ทำการเปลี่ยนชื่อเป็น ${devices[index]['divice_name']} เรียบร้อยแล้ว"),
                                    ),
                                  );
                                  Navigator.pop(context);
                                } else {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "คุณต้องการลบ ${item['divice_name']} ใช่หรือไม่?",
                        style: const TextStyle(
                          fontSize: 16,
