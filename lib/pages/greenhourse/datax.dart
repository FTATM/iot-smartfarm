...
class _DataxPageState extends State<DataxPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => _showCreateDataxDialog(context),
      ),

      body: SafeArea(
        child: ListView.builder(
          padding: const EdgeInsets.symmetric(vertical: 16),
          itemCount: dataxs.length,
          itemBuilder: (context, index) {
            final item = dataxs[index];
  ...
  void _showCreateDataxDialog(BuildContext context) {
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  hintText: "เลือก Branch ของ Datax",
                                  filled: true,
                                  fillColor: const Color(0xFFF9FAFB),
                                  contentPadding: const EdgeInsets.symmetric(
                                    horizontal: 16,
                                    ...
                                    if (newname['newname'] != '') {
                                      ...
                                      if (response['status'] == 'success') {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            content: Text("Datax ใหม่ ${newname['newname']} ถูกสร้างแล้ว!"),
                                          ),
                                        );
                                      } else {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(content: Text("Datax ใหม่ จำเป็นต้องมีชื่อ!")),
                                      );
                                    }
                                    newname['newname'] = '';
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if (response['status'] == 'success') {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text("ทำการเปลี่ยนชื่อเป็น ${dataxs[index]['datax_name']} เรียบร้อยแล้ว"),
                                    ),
                                  );
                                  Navigator.pop(context);
                                } else {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "คุณต้องการลบ ${item['datax_name']} ใช่หรือไม่?",
                        style: const TextStyle(
                          fontSize: 16,
